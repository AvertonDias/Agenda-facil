                              ...
                              <div className="flex items-center gap-1 ml-2">
                                <Tooltip>
                                  <TooltipTrigger asChild>
                                    <div className={cn("p-1 rounded-full", apt.confirmationSent ? "text-green-500 bg-green-50" : "text-muted-foreground/30")}>
                                      <Send className="w-3 h-3" />
                                    </div>
                                  </TooltipTrigger>
                                  <TooltipContent>
                                    <p className="text-[10px] font-bold">{apt.confirmationSent ? "Confirmação Enviada" : "Aguardando disparo automático"}</p>
                                  </TooltipContent>
                                </Tooltip>
                                <Tooltip>
                                  <TooltipTrigger asChild>
                                    <div className={cn("p-1 rounded-full", apt.reminderSent ? "text-blue-500 bg-blue-50" : "text-muted-foreground/30")}>
                                      <Zap className="w-3 h-3" />
                                    </div>
                                  </TooltipTrigger>
                                  <TooltipContent>
                                    <p className="text-[10px] font-bold">{apt.reminderSent ? "Lembrete 24h Enviado" : "Scheduler agendado"}</p>
                                  </TooltipContent>
                                </Tooltip>
                              </div>
                            </div>
